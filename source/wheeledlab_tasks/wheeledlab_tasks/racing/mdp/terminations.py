...
from .rewards import compute_progress_step, within_cones_mask
...
def goal_reached(env, eps_m: float = 0.5):
    ...
    - Gated by within_cones_mask so a car that cuts outside the boundary
      cannot trigger a false finish.
    """
    ...
    return (arrived | overshoot) & within_cones_mask(env)
