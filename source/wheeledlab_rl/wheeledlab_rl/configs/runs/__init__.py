...
register_run_to_hydra("RSS_RACING_CONFIG", RSS_RACING_CONFIG)
register_run_to_hydra("RSS_RACING_ASYM_CONFIG", RSS_RACING_ASYM_CONFIG)
register_run_to_hydra("RSS_RACING_PRIVILEGED_CONFIG", RSS_RACING_PRIVILEGED_CONFIG)
